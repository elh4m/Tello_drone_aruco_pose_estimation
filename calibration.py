...
'''
code from https://github.com/GSNCodes/ArUCo-Markers-Pose-Estimation-Generation-Python
Sample Usage:-
python calibration.py --dir calibration_checkerboard/ --square_size 0.03
'''
